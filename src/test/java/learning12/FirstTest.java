...
public class FirstTest {
	...
	// Verifications
		...
		public static void takesScreenshot() throws Exception
		{
			...
			String filePath = "E:\\Courses\\SELENIUM_Java_\\FailureScreenshot_" + timestamp + ".jpeg";
            
			File scrFile=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileHandler.copy(scrFile, new File(filePath));
			
			test.log(Status.INFO,"Screenshot --->" +test.addScreenCaptureFromPath(filePath));
		}
		...
		public static void reportFailure(String failureMsg) throws Exception 
		{
			...
			takesScreenshot();
			System.out.println("Both links are Not equal..." + failureMsg);
		}

		public static void reportSuccess(String SuccessMsg) 
		{
			test.log(Status.PASS, SuccessMsg);
			System.out.println("Both links are equal..." + SuccessMsg);
		}
